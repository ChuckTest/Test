...
namespace ConcurrentDictionaryDemo
{
    ...
    class Constructor
    {
        ...
        //
        //      ConcurrentDictionary<TKey, TValue>[TKey]    //访问ConcurrentDictionary类中的元素
        internal static void Test()
        {
            Console.WriteLine("构造函数测试开始"); 
            ...
            {
                cd[i] = i * i;//ConcurrentDictionary<TKey, TValue>[TKey] 
            }

            Console.WriteLine("The square of 23 is {0} (should be {1})", cd[23], 23 * 23);

            Console.WriteLine("构造函数测试结束"); 
        }
    }
}
